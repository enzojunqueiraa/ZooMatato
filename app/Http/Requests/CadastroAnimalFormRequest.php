...
class CadastroAnimalFormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
            ...
            'ra' => 'required|unique:animals|max:10|min:5',
    ...
    public function messages(){
        return [
            ...
            'ra.max' => 'O campo RA deve conter no máximo 30 caracteres.',
            'ra.min' => 'O campo RA deve conter no mínimo 5 caracteres.',
